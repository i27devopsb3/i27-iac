...
resource "google_compute_instance" "jenkins-master" {
  ...
  network_interface {
    ...
    subnetwork  = "projects/quantum-weft-420714/regions/us-central1/subnetworks/default"
  }
  ...
  service_account {
    email  = "702594967892-compute@developer.gserviceaccount.com"
